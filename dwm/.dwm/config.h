...
static const char col_gray1[]       = "#0A0E1F";
static const char col_gray2[]       = "#202A60";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_base, "-sf", col_gray4, NULL };
